...
keys(
  ...
  '<leader>ui',
  vim.show_pos,
  { desc = 'Highlight under cursor', silent = true }
...
-- Trouble.nvim
keys('n', '<leader>xx', function()
  require('trouble').open()
end)
keys('n', '<leader>xw', function()
  require('trouble').open 'workspace_diagnostics'
end)
keys('n', '<leader>xd', function()
  require('trouble').open 'document_diagnostics'
end)
keys('n', '<leader>xl', function()
  require('trouble').open 'quickfix'
end)
keys('n', '<leader>xq', function()
